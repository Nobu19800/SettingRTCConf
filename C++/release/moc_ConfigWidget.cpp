...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ConfigWidget_t, stringdata) + ofs \
...
const QMetaObject ConfigWidget::staticMetaObject = {
    { &MTabWidget::staticMetaObject, qt_meta_stringdata_ConfigWidget.data,
      qt_meta_data_ConfigWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ConfigWidget.stringdata))
