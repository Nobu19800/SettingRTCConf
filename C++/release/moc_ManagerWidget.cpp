...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ManagerWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 92, 11)
    ...
    "ManagerWidget\0addLangSlot\0\0delLangSlot\0"
    "createCompSlot\0delCompSlot\0delModuleSlot\0"
    "delPathSlot\0loadRTCSlot"
};
...
void ManagerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ManagerWidget *_t = static_cast<ManagerWidget *>(_o);
        switch (_id) {
        case 0: _t->addLangSlot(); break;
        case 1: _t->delLangSlot(); break;
        case 2: _t->createCompSlot(); break;
        case 3: _t->delCompSlot(); break;
        case 4: _t->delModuleSlot(); break;
        case 5: _t->delPathSlot(); break;
        case 6: _t->loadRTCSlot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ManagerWidget::staticMetaObject = {
    { &MTabWidget::staticMetaObject, qt_meta_stringdata_ManagerWidget.data,
      qt_meta_data_ManagerWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ManagerWidget.stringdata))
